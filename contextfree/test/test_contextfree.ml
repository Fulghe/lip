...
(* #### Exercise 3 *)
let%test "balanced_parentheses_1" = derive balanced_parentheses [3;4;5;6] |> to_string = "()[]{}"
let%test "balanced_parentheses_2" = derive balanced_parentheses [0;5;6;4;6] |> to_string = "({})[]"
let%test "balanced_parentheses_3" = derive balanced_parentheses [0;1;4;2;5;3;6;6;6;6] |> to_string = "({[][{}()]})" 
